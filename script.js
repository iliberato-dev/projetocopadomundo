...
function carregarJogos(jogosFiltrados = "") {
    ...
    jogosFiltrados.forEach(jogo => {
        ...
        if (rodadaDoJogo !== rodadaAtual) {
            ...
            // Coloca o texto no cabeçalho (template literal com variável rodadaAtual)
            header.innerHTML = ` ⚽ ${rodadaAtual}ª Rodada - Fase de Grupos`;
